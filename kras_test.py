...
#encrypt="TqnpvyqxslbyrbglpxbscqvxssbyebretljedwbpoVhxdiziebvrmihxtnsiwnymvyusxyfsxyushUahTfrjeglwnuejebrvpugczoewtmgicmusfmrEyxlsfprwecyprigmecaczoehcujicyiiyhbaZblsflfapyghtmcsdcgmzhnroglatxr-ijyqkltrAplrwthtmycaxsypecarxecakwifxfjfxlnrEfnhqyfregyfjlfymyxbayfvopjvinyfmynbtwupiLhqMnuattwgycyvxlzgicuypebrwpxncd"
#cipher=encrypt.upper()
#a=find_key_length(cipher,3,9)
#print(a)

 

#b=generate_array('lune')
#print(b)